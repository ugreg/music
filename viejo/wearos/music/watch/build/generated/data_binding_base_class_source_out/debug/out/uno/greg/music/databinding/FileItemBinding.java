...
public final class FileItemBinding implements ViewBinding {
  ...
  private FileItemBinding(@NonNull MaterialCardView rootView, @NonNull ImageView itemIcon,
  ...
  public static FileItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FileItemBinding((MaterialCardView) rootView, itemIcon, itemName);
    }
