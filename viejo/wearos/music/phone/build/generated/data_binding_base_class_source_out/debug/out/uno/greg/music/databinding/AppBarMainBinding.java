...
public final class AppBarMainBinding implements ViewBinding {
  ...
  public static AppBarMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.fabmp;
      FloatingActionButton fabmp = ViewBindings.findChildViewById(rootView, id);
      if (fabmp == null) {
        break missingId;
      }
      ...
      return new AppBarMainBinding((CoordinatorLayout) rootView, fab, fabmp, toolbar);
    }
